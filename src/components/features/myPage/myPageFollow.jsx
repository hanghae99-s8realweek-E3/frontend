...
function MyPageFollow() {
    ...
    const onClickDelete = (e) => {
        // e.preventDefault();
        const resetFollowing = following.filter((x)=> {
            return x.userId !== e;
        })
        setFollowing(resetFollowing)
        console.log(resetFollowing)
    }
                    ...
                    <StProfileBox>
                        <StProfileImg height="200px" width="200px" src={x.profileImg}></StProfileImg>
                            <StWrapNicknameMbti>
                                ...
                                <StDeleteFollowBtn type="submit" onClick={()=>onClickDelete(x.userId)}>삭제</StDeleteFollowBtn>
                    </StProfileBox>
                        </div>)
            })}</div>
        </StContainer>
